...
class RobertaLayer(nn.Module):
    ...
    def forward(
        ...
        if is_decoder and encoder_hidden_states is not None:
...
class RobertaModelForDecoder(RobertaPreTrainedModel):
    ...
    def extract_features(
        ...
        span_mask_list, span_mask_padding_list = self.forward_span_embedding(tgt_mask_segment, tgt_span_length)
    ...
    def forward(
        ...
        return nn.functional.log_softmax(decoder_out, -1) if normalize else decoder_out, 
...
class RobertaModel(RobertaPreTrainedModel):
    ...
    def forward(
        ...
        sn_pos: Optional[torch.Tensor] = None,
        is_decoder: Boolean=False,
        _add_special_token_mask: Boolean=False,
        ...
        # print("encoder_extended_attention_mask")
